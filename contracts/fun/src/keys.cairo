...
use joy_fun::keys_types::{
    ...
    BondingType, KeysBonding, KeysBondingImpl, MINTER_ROLE, ADMIN_ROLE, get_current_price
};
...
pub trait IKeysMarketplace<TContractState> {
    ...
    fn instantiate_keys(
        ref self: TContractState, // token_quote: TokenQuoteBuyKeys, // registration_type: KeysMarketplace::BondingType,
    );
...
mod KeysMarketplace {
    ...
    impl KeysMarketplace of super::IKeysMarketplace<ContractState> {
        ...
        // registration_type: BondingType, 
            ...
            let bond_type = BondingType::Basic;
            let key = Keys {
                owner: caller,
        ...
        fn sell_keys(ref self: ContractState, address_user: ContractAddress, amount: u256) {
            ...
            if old_share.owner.is_zero() {
                ...
                println!("Decrease amount owned {}", share_user.amount_owned);
